...
namespace elib { namespace aux
{
    namespace detail
    {
        ...
        namespace swap_adl_barrier
        {
            ...
            using swap_adl_barrier::is_nothrow_swappable_impl;
    }                                                       // namespace detail
        
    template <class T, class U = T>
    using is_swappable = decltype(detail::is_swappable_impl<T, U>(0));
        
    template <class T, class U = T>
    using is_nothrow_swappable = typename 
        detail::is_nothrow_swappable_impl<T, U>::type;
