#ifndef ELIB_AUX_TRAITS_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE_HPP
#define ELIB_AUX_TRAITS_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE_HPP
...
#endif /* ELIB_AUX_TRAITS_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE_HPP */
