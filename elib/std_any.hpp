#ifndef ELIB_STD_ANY_HPP
#define ELIB_STD_ANY_HPP
...
{
    ////////////////////////////////////////////////////////////////////////////
    class bad_std_any_cast : std::bad_cast
    {
    public:
        virtual const char* what() const noexcept
        {
            return "bad std_any cast";
        }
    };
    
    namespace std_any_detail
    {
        ////////////////////////////////////////////////////////////////////////
        struct storage_base
        {
    ...
    public:
        ...
        // std_any(std::allocator_arg_t, Allocator const & alloc);
        
        ////////////////////////////////////////////////////////////////////////
        template <class Allocator, class ValueType>
        std_any(std::allocator_arg_t, Allocator const & alloc, ValueType && value)
        {
            using StoredValue = aux::decay_t<ValueType>;
        ...
        std_any & operator=(std_any const & other)
        {
            std_any(other).swap(*this);
            return *this;
        }
        
        std_any & operator=(std_any && other) noexcept
        {
            this->swap(other);
            return *this;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        template <class ValueType>
        std_any & operator=(ValueType && value)
        {
            std_any(elib::forward<ValueType>(value)).swap(*this);
            return *this;
        }
        ...
        ////////////////////////////////////////////////////////////////////////
        void swap(std_any & other) noexcept
        {
    ...
    private:
        using buffer_t = std_any_detail::buffer_t;
        using storage_base = std_any_detail::storage_base;
        
        template <class ValueType, class Alloc = std::allocator<ValueType>>
        using storage_type = std_any_detail::storage_type<ValueType, Alloc>;
        
        template <class ValueType, class Alloc = std::allocator<ValueType>>
        using store_locally = std_any_detail::store_locally<ValueType, Alloc>;
    ...
    private:
        template <class T> friend T std_any_cast(std_any const &);
        template <class T> friend T std_any_cast(std_any &);
        template <class T> friend T std_any_cast(std_any &&);
        template <class T> friend T const * std_any_cast(std_any const *) noexcept;
        template <class T> friend T * std_any_cast(std_any *) noexcept;
    ...
    ////////////////////////////////////////////////////////////////////////////
    void swap(std_any & lhs, std_any & rhs) noexcept
    {
        lhs.swap(rhs);
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    template <class ValueType>
    inline ValueType const * std_any_cast(std_any const * v) noexcept
    {
    ...
    ////////////////////////////////////////////////////////////////////////////
    template <class ValueType>
    inline ValueType * std_any_cast(std_any * v) noexcept
    {
        return v && v->m_base_ptr 
    ...
    template <class ValueType>
    ValueType std_any_cast(std_any const & v)
    {
        static_assert(
        ...
        auto ptr = std_any_cast<CastType>(&v);
        if (not ptr) {
            throw bad_std_any_cast();
        }
        return *ptr;
    }
    ...
    ////////////////////////////////////////////////////////////////////////////
    template <class ValueType>
    ValueType std_any_cast(std_any & v)
    {
        static_assert(
            aux::is_reference<ValueType>::value
            || aux::is_copy_constructible<ValueType>::value
    ...
    ValueType std_any_cast(std_any && v)
    {
        return std_any_cast<ValueType>(static_cast<std_any const &>(v));
    }

}                                                           // namespace elib
#endif /* ELIB_STD_ANY_HPP */