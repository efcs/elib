...
TEST_SUITE(elib_iterator_traits_test_suite)

TEST_CASE(iterator_traits_t_test)
{
    using T = input_it;
...
TEST_CASE(iterator_tag_traits_test)
{
    {
...
TEST_CASE(is_iteroperable_test)
{
...
TEST_CASE(choose_iterator_traits_test)
{
...
TEST_CASE(choose_difference_type_test)
{
