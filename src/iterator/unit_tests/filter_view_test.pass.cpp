// REQUIRES: ELIB_ITERATOR_SOURCE, ELIB_BOOST_TEST
...
BOOST_AUTO_TEST_SUITE(elib_iterator_filter_view_test_suite)


BOOST_AUTO_TEST_CASE(non_const_ctor_test)
{
    vector_t s;
    pred_t p;
    const vector_t cs;
...
BOOST_AUTO_TEST_CASE(rbegin_rend_test)
{
    vector_t in = {0, 1, 2, 3, 4, 5};
