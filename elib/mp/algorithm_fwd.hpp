#ifndef ELIB_MP_ALGORITHM_FWD_HPP
#define ELIB_MP_ALGORITHM_FWD_HPP
...
namespace elib 
{
  ...
  //-------------------------------- lower_bound ----------------------------//
    ...
    template <class Seq, class T, class Pred> struct lower_bound;
   
  //-------------------------------- upper_bound ----------------------------//
  
    template <class Seq, class T, class Pred> struct upper_bound;
  
  //-------------------------------- min_element ----------------------------// 
  
    template <class Seq, class Pred> struct min_element;
    
  //-------------------------------- max_element ----------------------------//
  
    template <class Seq, class Pred> struct max_element;
  
  //-------------------------------- equal ----------------------------------// 
  
    template <class Seq1, class Seq2, class Pred> struct equal;
...
#endif /* ELIB_MP_ALGORITHM_FWD_HPP */