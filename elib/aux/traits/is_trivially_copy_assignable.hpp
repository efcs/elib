#ifndef ELIB_AUX_TRAITS_IS_TRIVIALLY_COPY_ASSIGNABLE_HPP
#define ELIB_AUX_TRAITS_IS_TRIVIALLY_COPY_ASSIGNABLE_HPP
...
#endif /* ELIB_AUX_TRAITS_IS_TRIVIALLY_COPY_ASSIGNABLE_HPP */
