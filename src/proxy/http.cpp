...
#define PROXY_HTTP_METHOD_MAP_ITEM(Name) \
    {::prox::http_method::Name, #Name}
    
#define PROXY_HTTP_STATUS_MAP_ITEM(Name) \
    {::prox::http_status::Name, #Name}

namespace elib { namespace enumeration
{
    constexpr const ::prox::http_method 
    basic_enum_traits<::prox::http_method>::ELIB_ENUM_FIRST_VALUE;
    
    constexpr const ::prox::http_method 
    basic_enum_traits<::prox::http_method>::ELIB_ENUM_LAST_VALUE;
    
    constexpr const bool 
    basic_enum_traits<::prox::http_method>::ELIB_ENUM_IS_CONTIGIOUS;
...
# endif
    ...
    const std::map<::prox::http_method, std::string> 
    basic_enum_traits<::prox::http_method>::name_map =
    {
    ...
    const std::map<::prox::http_status, std::string>
    basic_enum_traits<::prox::http_status>::name_map =
    {
