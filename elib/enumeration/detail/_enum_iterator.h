#ifndef ELIB_ENUMERATION__ENUM_ITERATOR_H
#define ELIB_ENUMERATION__ENUM_ITERATOR_H

#ifndef ELIB_ENUMERATION_ENUM_ITERATOR_H
...
#endif /* ELIB_ENUMERATION__ENUM_ITERATOR_H */