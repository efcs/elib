...
if ( ${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU" )
    include(config/gcc-config.cmake)
elseif( ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang" )
    include(config/clang-config.cmake)
else()
    message( FATAL_ERROR "Compiler not supported! (${CMAKE_CXX_COMPILER_ID})" )
endif()

if (CONFIG_ALL_WARNINGS)
    include(config/warning-flags.cmake)
endif()
...
elseif(CYGWIN)
    include(config/cygwin-config.cmake)
endif()

# Travis CI enviroment specific configuration.
if (DEFINED ENV{TRAVIS})
    include(config/travis-config.cmake)
endif()
