...
#   define ELIB_ASSERT_ON__ 1

#   if defined(ELIB_DEBUG_ON)
#     define ELIB_DEBUG_ON__ 1
#   endif

#   if defined(ELIB_WARN_ON) || defined(ELIB_DEBUG_ON__)
#     define ELIB_WARN_ON__ 1
#   endif
...
#   endif /* ELIB_ASSERT_NO_EXIT */
  ...
  namespace elib 
  {
    ...
    inline void 
    elib_assert(bool pred,  const char* pred_str,  
...
# define ELIB_ASSERT_2(pred, msg) \
    ::elib::elib_assert(pred,  "" #pred, __FILE__,  __func__, __LINE__, msg)
            
# define ELIB_ASSERT(...) \
    ELIB_PP_OVERLOAD(ELIB_ASSERT_,  __VA_ARGS__)(__VA_ARGS__)

#   else                                                    // _ELIB_ASSERT_ON__

# define ELIB_ASSERT(...)          ((void)0)

#   endif                                                     // _ELIB_ASSERT_ON__

////////////////////////////////////////////////////////////////////////////////
//                              ELIB_WARN                                       
////////////////////////////////////////////////////////////////////////////////

# ifdef ELIB_WARN_ON__
...
#   include <iostream> 
  ...
  namespace elib
  {
    ...
    inline void elib_warn(
      bool pred, const char* pred_str 
      , const char* filename
      , const char* func
      , int line
      , const char* opt_msg=nullptr 
...
# define ELIB_WARN(...) \
    ELIB_OVERLOAD(ELIB_WARN_, __VA_ARGS__)(__VA_ARGS__)

# else                                                      // _ELIB_WARN_ON__

#   define ELIB_WARN(...)            ((void)0)

# endif                                                     // _ELIB_WARN_ON__

////////////////////////////////////////////////////////////////////////////////
//                            ELIB DEBUG                                                       
////////////////////////////////////////////////////////////////////////////////

# ifdef ELIB_DEBUG_ON__
...
#   include <iostream>
  ...
  {
    inline void 
    elib_debug(bool pred, const char* pred_str, 
...
# define ELIB_DEBUG(...) \
    ELIB_OVERLOAD(ELIB_DEBUG_, __VA_ARGS__)(__VA_ARGS__)

# define ELIB_DEBUG_1(pred) \
    ELIB_DEBUG_2(pred, nullptr)
  
# define ELIB_DEBUG_2(pred, msg)       \
    ::elib::elib_debug(pred, "" # pred \
...
# undef ELIB_ASSERT_ON__
# undef ELIB_WARN_ON__
# undef ELIB_DEBUG_ON__
